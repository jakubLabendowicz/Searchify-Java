...
const Favorites = () => {
    ...
    const handleGetSelfFavoritesTracks = async () => {
        try {
            ...
            const url = "http://localhost:8081/api/users/self/favorites"
                                ...
                                sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                    ...
                                    <TableCell align="right">
                                        <Stack direction="row" alignItems="center" spacing={1}>
                                            ...
                                            <IconButton aria-label="star" size="small" onClick={()=>{handleDeleteSelfFavorite(row.track.id)}}>
                                                <StarIcon />
                                            </IconButton>
                                        </Stack>
                                    </TableCell>
